...
import { SessionService, RedirectionService, UserService } from './practice';

describe('practice', () => {
  describe('SessionService', () => {
    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [RoutingTestingModule, HttpClientTestingModule],
        providers: [SessionService],
      });
    });

    describe('authenticate', () => {
      it('should request authentication from api endpoint', fakeAsync(
        inject(
          [SessionService, HttpTestingController],
          (service: SessionService, httpMock: HttpTestingController) => {
            // Arrange
  ...
  describe('RedirectionService', () => {
    ...
    describe('when redirection is set', () => {
      ...
      beforeEach(inject([RedirectionService], (service: RedirectionService) => {
      ...
      it('should redirect to redirect/url after new user logs in', inject(
        [RedirectionService, Location],
        async (service: RedirectionService, ngLocation: SpyLocation) => {
